...
const updateTeamBuildingService = async (req, res) => {
  try {
    ...
    await logAdminAction(
      req.user._id,
      req.user.username, // hoặc req.user.email nếu bạn dùng email làm username
      "Cập nhật dịch vụ TeamBuilding",
      null, // targetUser nếu có (ví dụ khi admin thao tác lên user nào đó)
      { updatedFields: updateData } // details tùy chọn
    );
