      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          <nav style={{ display: 'flex', borderBottom: '2px solid #e5e7eb', marginBottom: '16px' }}>
            ...
            <button
              onClick={() => handleImageTabClick('food')}
              style={{
                padding: '12px 24px',
                borderBottom: activeImageTab === 'food' ? '3px solid #3b82f6' : '3px solid transparent',
                fontWeight: activeImageTab === 'food' ? '700' : '500',
                color: activeImageTab === 'food' ? '#2563eb' : '#6b7280',
                backgroundColor: 'transparent',
                border: 'none',
                cursor: 'pointer',
                fontSize: '16px'
